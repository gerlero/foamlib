...
def test_deprecated_control_dict() -> None:
    ...
    from foamlib.preprocessing.system import controlDict
...
def test_deprecated_fv_schemes() -> None:
    ...
    from foamlib.preprocessing.system import fvSchemes
...
def test_deprecated_fv_solution() -> None:
    ...
    from foamlib.preprocessing.system import fvSolution
